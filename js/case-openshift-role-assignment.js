...
(function () {
  ...
  window.RBAC_ROLE_ASSIGNMENT_BLOCK = {
    ...
    introHtml: {
      ...
      zh: "<strong>Manage permissions</strong> 页面负责项目级 RBAC 编辑，采用单页事务模型：顶部选择 user/group，中部表格批量勾选角色，底部通过 <span class=\"fc-rbac-assign__medium\">Save / Cancel</span> 提交或放弃。",
    },
    challenges: [
      {
        painHtml: {
          ...
          zh: "受技术与安全限制，OpenShift <strong>无法获取完整 user/group 列表</strong>，项目管理员只能手动输入用户或组名。对已授权主体重复手动输入会增加管理成本。",
        },
        painTitle: {
        ...
        solutionTitle: {
          ...
          zh: "User/group 选择的 Typeahead 输入",
        },
        solutionBody: {
          ...
          zh: "为解决上述痛点，引入 Typeahead 输入方案：管理员可从建议中选择已授权用户，或按需手动输入新 user/group。",
        },
        ...
        annotations: [
          ...
          },
          {
            html: {
              ...
              zh: "若需选择<strong>新 user/group</strong>，下拉列表第一项即为目标选项。",
            },
          },
          {
            html: {
        ...
        annotations: [
          {
            html: {
              ...
              zh: "<strong>复选框</strong> 使用户无需额外说明即可轻松勾选或取消角色。",
            },
          },
          {
            html: {
      ...
      },
      {
        ...
        solutionHtml: {
          ...
          zh: "为提升列表可扫读性，引入了「Assignment status」这一列数据。用户可按状态排序，快速找到所需项并轻松管理分配。",
        },
        solutionTitle: {
        ...
        statusLegend: [
          ...
          },
          {
            ...
            footnote: {
              ...
              zh: "Role can only be re-assigned in OpenShift",
            },
          },
        ],
      },
      {
        painBody: {
          ...
          zh: "即使有 Assignment status，大量编辑仍可能被遗漏，导致误配与安全风险，因此需要让管理员快速核对全部修改。",
        },
        painTitle: {
